...
const Device = () => {
    ...
    const handleExportExcel = () => {
        const exportData = dataSource.map(({ id, area, updated, organization, ...rest }) => rest); 
    ...
    const menu = (
        <Menu>
            ...
            <Menu.Item>
                <CSVLink data={dataSource.map(({ id, area, updated, organization, ...rest }) => rest)} filename="Devices.csv">
                    Export CSV
                </CSVLink>
            </Menu.Item>
        </Menu>
