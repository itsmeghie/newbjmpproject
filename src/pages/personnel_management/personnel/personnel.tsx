...
const Personnel = () => {
    ...
    const handleExportExcel = () => {
        const exportData = dataSource.map(({ updated_by,record_status, ...rest }) => rest); 
    ...
    const menu = (
        <Menu>
            ...
            <Menu.Item>
                <CSVLink data={dataSource.map(({ record_status,updated_by, ...rest }) => rest)} filename="Personnel.csv">
                    Export CSV
                </CSVLink>
            </Menu.Item>
        </Menu>
