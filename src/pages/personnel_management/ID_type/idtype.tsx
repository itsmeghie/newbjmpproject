...
const ID_Types = () => {
    ...
    const handleExportExcel = () => {
        ...
        XLSX.utils.book_append_sheet(wb, ws, "IDType");
        XLSX.writeFile(wb, "IDType.xlsx");
    };
    ...
    const menu = (
        <Menu>
            ...
            <Menu.Item>
                <CSVLink data={dataSource.map(({ id, organization,updated_by, ...rest }) => rest)} filename="IDTypes.csv">
                    Export CSV
                </CSVLink>
            </Menu.Item>
        </Menu>
