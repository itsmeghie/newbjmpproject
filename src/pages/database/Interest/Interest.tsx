...
const Interest = () => {
    ...
    const handleExportExcel = () => {
        const exportData = dataSource.map(({ id, organization, updated_by, record_status, ...rest }) => rest); 
    ...
    const menu = (
        <Menu>
            ...
            <Menu.Item>
                <CSVLink data={dataSource.map(({ id,organization,updated_by, ...rest }) => rest)} filename="Interest.csv">
                    Export CSV
                </CSVLink>
            </Menu.Item>
        </Menu>
